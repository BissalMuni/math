...
export default function Calculus() {
  return (
    <div className="space-y-8">
      <CalcBox title="1. 편미분 (Partial Derivative)">
      ...
      <CalcBox title="2. 연쇄 법칙 (Chain Rule)">
      ...
      <CalcBox title="3. 그래디언트 (Gradient)">
      ...
      <CalcBox title="4. 지수 함수 (Exponential Function)">
