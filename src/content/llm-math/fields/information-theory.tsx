...
export default function InformationTheory() {
  return (
    <div className="space-y-8">
      ...
      <CalcBox title="2. 교차 엔트로피 (Cross-Entropy)">
      ...
      <CalcBox title="3. KL 발산 (KL Divergence)">
      ...
      <CalcBox title="4. 퍼플렉시티 (Perplexity)">
      ...
      <CalcBox title="5. 상호 정보량 (Mutual Information)">
