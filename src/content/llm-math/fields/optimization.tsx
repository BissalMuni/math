...
export default function Optimization() {
  return (
    <div className="space-y-8">
      <CalcBox title="1. 경사 하강법 (Gradient Descent)">
      ...
      <CalcBox title="4. 학습률 스케줄링 (Learning Rate Scheduling)">
      ...
      <CalcBox title="5. 정규화 (Regularization)">
