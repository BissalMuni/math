...
export default function Optimization() {
  return (
    <div className="space-y-8">
      <CalcBox title="경사 하강법 (Gradient Descent)">
      ...
      <CalcBox title="학습률 스케줄링 (Learning Rate Scheduling)">
      ...
      <CalcBox title="정규화 (Regularization)">
