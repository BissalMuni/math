...
export default function Probability() {
  return (
    <div className="space-y-8">
      <CalcBox title="1. 조건부 확률 (Conditional Probability)">
      ...
      <CalcBox title="4. 기대값 (Expected Value)">
        <p>손실 함수가 기대 손실의 추정입니다. RLHF에서 보상의 기대값을 최대화합니다.</p>
        <BlockMath math="E[X] = \sum_i x_i P(x_i)" />
        <p className="mt-2 text-sm text-muted">교육과정: 고등학교 확률과 통계</p>
      </CalcBox>

      <CalcBox title="5. 분산/표준편차 (Variance/Standard Deviation)">
      ...
      <CalcBox title="6. 정규 분포 (Normal Distribution)">
