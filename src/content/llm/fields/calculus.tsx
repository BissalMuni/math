...
export default function Calculus() {
  return (
    <div className="space-y-8">
      <CalcBox title="편미분 (Partial Derivative)">
      ...
      <CalcBox title="연쇄 법칙 (Chain Rule)">
      ...
      <CalcBox title="지수 함수 (Exponential Function)">
