...
export default function InformationTheory() {
  return (
    <div className="space-y-8">
      <section id="entropy">
        <h2 className="text-xl font-semibold mb-3">엔트로피 (Entropy)</h2>
      ...
      <section id="cross-entropy">
        <h2 className="text-xl font-semibold mb-3">교차 엔트로피 (Cross-Entropy)</h2>
      ...
      <section id="kl-divergence">
        <h2 className="text-xl font-semibold mb-3">KL 발산 (KL Divergence)</h2>
      ...
      <section id="perplexity">
        <h2 className="text-xl font-semibold mb-3">퍼플렉시티 (Perplexity)</h2>
      ...
      <section id="mutual-information">
        <h2 className="text-xl font-semibold mb-3">상호 정보량 (Mutual Information)</h2>
