...
export default function LinearAlgebra() {
  return (
    <div className="space-y-8">
      ...
      <CalcBox title="행렬 곱셈 (Matrix Multiplication)">
      ...
      <CalcBox title="고유값/고유벡터 (Eigenvalue/Eigenvector)">
