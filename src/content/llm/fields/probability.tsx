  ...
  return (
    <div className="space-y-8">
      <section id="conditional-probability">
        <h2 className="text-xl font-semibold mb-3">조건부 확률 (Conditional Probability)</h2>
      ...
      <section id="joint-probability">
        <h2 className="text-xl font-semibold mb-3">결합 확률 (Joint Probability)</h2>
      ...
      <section id="bayes-theorem">
        <h2 className="text-xl font-semibold mb-3">베이즈 정리 (Bayes' Theorem)</h2>
      ...
      <section id="expected-value">
        <h2 className="text-xl font-semibold mb-3">기대값 (Expected Value)</h2>
      ...
      <section id="variance">
        <h2 className="text-xl font-semibold mb-3">분산/표준편차 (Variance/Standard Deviation)</h2>
      ...
      <section id="normal-distribution">
        <h2 className="text-xl font-semibold mb-3">정규 분포 (Normal Distribution)</h2>
      ...
      <section id="mle">
        <h2 className="text-xl font-semibold mb-3">최대 우도 추정 (MLE)</h2>
      ...
      <section id="sampling">
        <h2 className="text-xl font-semibold mb-3">샘플링 (Sampling)</h2>
