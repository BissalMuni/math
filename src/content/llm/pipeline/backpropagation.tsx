...
export default function Backpropagation() {
  return (
    <div className="space-y-8">
      ...
      <section>
        <h2 className="text-xl font-semibold mb-3">연쇄 법칙 — 그래디언트 역전파</h2>
      ...
      <section>
        <h2 className="text-xl font-semibold mb-3">Vanishing / Exploding Gradient</h2>
      ...
      <section>
        <h2 className="text-xl font-semibold mb-3">자동 미분 (Autograd)</h2>
