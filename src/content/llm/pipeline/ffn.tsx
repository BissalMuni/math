...
export default function FFN() {
  return (
    <div className="space-y-8">
      ...
      <section>
        <h2 className="text-xl font-semibold mb-3">선형 변환 — 두 번의 완전 연결</h2>
      ...
      <section>
        <h2 className="text-xl font-semibold mb-3">활성화 함수 — 비선형성</h2>
      ...
      <section>
        <h2 className="text-xl font-semibold mb-3">잔차 연결 — 그래디언트 흐름</h2>
