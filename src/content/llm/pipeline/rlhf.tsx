...
export default function RLHF() {
  return (
    <div className="space-y-8">
      ...
      <section>
        <h2 className="text-xl font-semibold mb-3">보상 모델 (Reward Model)</h2>
      ...
      <section>
        <h2 className="text-xl font-semibold mb-3">PPO (Proximal Policy Optimization)</h2>
      ...
      <section>
        <h2 className="text-xl font-semibold mb-3">DPO (Direct Preference Optimization)</h2>
