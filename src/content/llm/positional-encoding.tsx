  ...
  return (
    <div className="space-y-8">
      <p className="text-muted">
        트랜스포머는 모든 토큰을 동시에 처리합니다 — RNN처럼 순서대로 읽지 않습니다.
        그래서 위치 정보를 임베딩에 더해 순서를 표현해야 합니다.
      </p>
      ...
      <Insight>
        ...
        sin/cos 조합으로 차원마다 다른 주기를 만들면 모든 위치가 고유한 벡터를 갖게 된다.
        이 PE 벡터를 임베딩에 단 한 번만 더해 위치 정보를 주입한다.
      </Insight>
    </div>
  );
}
