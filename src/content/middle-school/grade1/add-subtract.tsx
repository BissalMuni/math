...
export default function AddSubtract() {
  return (
    <div className="space-y-8">
      ...
      <CalcBox title="■ 덧셈">
        <SubSection title="● 부호가 같은 두 수의 덧셈">
          <p>
        ...
        <SubSection title="● 부호가 다른 두 수의 덧셈">
          <p>
            절댓값이 큰 수에서 작은 수를 빼고,{" "}
      ...
      <CalcBox title="■ 유리수의 덧셈과 뺄셈">
        <SubSection title="● 분수의 덧셈·뺄셈">
          <p>
