...
export default function PolynomialCalc() {
  return (
    <div className="space-y-8">
      <CalcBox title="■ 단항식의 계산">
        <SubSection title="● 단항식의 곱셈">
          <p>
      ...
      <CalcBox title="■ 단항식과 다항식의 곱셈·나눗셈">
        <SubSection title="● 단항식 × 다항식">
          <p>
